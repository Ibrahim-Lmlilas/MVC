                ...
                <?php foreach ($projects as $project): ?>
                    <tr>
                        ...
                        <td class="px-6 py-4 text-sm font-medium leading-5 text-right whitespace-no-wrap border-b border-gray-200 flex justify-evenly">
                            ...
                            <form method="POST" action="/client/projects/removeProject" class="mb-0" onsubmit="return confirm('Are you sure you want to remove this project?');">
...
<?php require_once(__DIR__ . '/projectPopUp.php'); ?>
